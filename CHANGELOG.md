...
- Across Debian, Kubuntu, and GRUB-based installations of EndeavourOS and CachyOS, validated fresh installation, clean upgrades, explicit snapshot activation, native Snapper rollback, and reboot testing, with migration from BootPrep 1.x to 2.0.0 validated on Debian.
