...
BootPrep is compatible with Debian, Ubuntu, EndeavourOS, CatchyOS, and many related derivatives that meet these requirements. Version 2.0.0 has been exercised directly on Debian, Kubuntu, and GRUB-based installations of EndeavourOS and CatchyOS. Distribution packaging and Snapper integration still vary, so testing with a verified recovery path is recommended before deployment on another distribution.
...
Across Debian, Kubuntu, and GRUB-based installations of EndeavourOS and CatchyOS, Version 2.0.0 has been tested through fresh installation, v1 migration where applicable, clean upgrade, explicit activation, native Snapper rollback, and reboot.
